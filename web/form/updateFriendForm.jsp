        ...
        <form action="UpdateFriend">
            <table>
                ...
                <tr>
                    ...
                    <td><input name="sex"  type="radio" value="M" checked="<%="M".equals(friend.getSex())?true:false%>">男
                    <input name="sex"  type="radio" value="F" checked="<%="F".equals(friend.getSex())?true:false%>">女</td>
                </tr>
                <tr>
